  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
      <div class="d-flex justify-content-center">
        <button class="btn btn-info my-5"><a href="admin_interface.php" class="text-light"><i class="fas fa-tachometer-alt"></i> Admin Profile</a></button>
        <button class="btn btn-info my-5"><a href="nurselist.php" class="text-light"><i class="fas fa-user-injured"></i> Nurse Lists</a></button>
        <button class="btn btn-info my-5"><a href="addnurse.php" class="text-light"><i class="fas fa-user-plus"></i> Add Nurse</a></button>
        ...
        <button class="btn btn-info my-5"><a href="insertmed.php" class="text-light"><i class="fas fa-medkit"></i> Add Medicine</a></button>
